-- Fix the cards_with_prices view properly
-- First drop the existing view, then create the correct one
...
-- Create the cards_with_prices view with the correct structure
