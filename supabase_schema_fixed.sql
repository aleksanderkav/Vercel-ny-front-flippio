-- Trading Card Tracker Database Schema (FIXED)
...
CREATE TABLE IF NOT EXISTS cards (
    ...
    card_set VARCHAR(255) NOT NULL,  -- Changed from "set" to "card_set"
...
INSERT INTO cards (name, card_set, condition, current_price, average_price, lowest_price, highest_price, market_distribution, total_listings, emoji, market) VALUES
