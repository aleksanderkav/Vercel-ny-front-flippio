...
-- Base Set Classics
('Charizard PSA 10', 2500.00, 'Pokemon', 'Pokemon', 'Base Set', 1999, 'PSA 10', 'Holo Rare', NOW(), NOW()),
('Pikachu PSA 9', 180.00, 'Pokemon', 'Pokemon', 'Base Set', 1999, 'PSA 9', 'Common', NOW(), NOW()),
('Blastoise PSA 8', 450.00, 'Pokemon', 'Pokemon', 'Base Set', 1999, 'PSA 8', 'Holo Rare', NOW(), NOW()),
('Venusaur PSA 9', 380.00, 'Pokemon', 'Pokemon', 'Base Set', 1999, 'PSA 9', 'Holo Rare', NOW(), NOW()),
('Mewtwo PSA 10', 1200.00, 'Pokemon', 'Pokemon', 'Base Set', 1999, 'PSA 10', 'Holo Rare', NOW(), NOW()),

-- Modern Pokemon
('Charizard VMAX PSA 10', 800.00, 'Pokemon', 'Pokemon', 'Champions Path', 2020, 'PSA 10', 'VMAX', NOW(), NOW()),
('Pikachu V PSA 9', 95.00, 'Pokemon', 'Pokemon', 'Vivid Voltage', 2020, 'PSA 9', 'V', NOW(), NOW()),
('Sylveon GX PSA 10', 320.00, 'Pokemon', 'Pokemon', 'Guardians Rising', 2017, 'PSA 10', 'GX', NOW(), NOW()),
('Umbreon GX PSA 9', 280.00, 'Pokemon', 'Pokemon', 'Sun and Moon', 2017, 'PSA 9', 'GX', NOW(), NOW()),
('Espeon GX PSA 8', 180.00, 'Pokemon', 'Pokemon', 'Sun and Moon', 2017, 'PSA 8', 'GX', NOW(), NOW()),

-- Eeveelutions
('Vaporeon PSA 9', 120.00, 'Pokemon', 'Pokemon', 'Jungle', 1999, 'PSA 9', 'Holo Rare', NOW(), NOW()),
('Jolteon PSA 8', 95.00, 'Pokemon', 'Pokemon', 'Jungle', 1999, 'PSA 8', 'Holo Rare', NOW(), NOW()),
('Flareon PSA 9', 110.00, 'Pokemon', 'Pokemon', 'Jungle', 1999, 'PSA 9', 'Holo Rare', NOW(), NOW()),
('Leafeon GX PSA 10', 220.00, 'Pokemon', 'Pokemon', 'Guardians Rising', 2017, 'PSA 10', 'GX', NOW(), NOW()),
('Glaceon GX PSA 9', 190.00, 'Pokemon', 'Pokemon', 'Guardians Rising', 2017, 'PSA 9', 'GX', NOW(), NOW()),

-- Legendary Pokemon
('Mew PSA 10', 850.00, 'Pokemon', 'Pokemon', 'Base Set', 1999, 'PSA 10', 'Holo Rare', NOW(), NOW()),
('Lugia PSA 9', 420.00, 'Pokemon', 'Pokemon', 'Neo Genesis', 2000, 'PSA 9', 'Holo Rare', NOW(), NOW()),
('Ho-Oh PSA 8', 280.00, 'Pokemon', 'Pokemon', 'Neo Revelation', 2001, 'PSA 8', 'Holo Rare', NOW(), NOW()),
('Rayquaza GX PSA 10', 380.00, 'Pokemon', 'Pokemon', 'Celestial Storm', 2018, 'PSA 10', 'GX', NOW(), NOW()),
('Giratina PSA 9', 320.00, 'Pokemon', 'Pokemon', 'Platinum', 2009, 'PSA 9', 'Holo Rare', NOW(), NOW()),

-- Popular Pokemon
('Snorlax PSA 8', 180.00, 'Pokemon', 'Pokemon', 'Jungle', 1999, 'PSA 8', 'Holo Rare', NOW(), NOW()),
('Gyarados PSA 9', 220.00, 'Pokemon', 'Pokemon', 'Base Set', 1999, 'PSA 9', 'Holo Rare', NOW(), NOW()),
('Dragonite PSA 8', 160.00, 'Pokemon', 'Pokemon', 'Fossil', 1999, 'PSA 8', 'Holo Rare', NOW(), NOW()),
('Tyranitar PSA 9', 280.00, 'Pokemon', 'Pokemon', 'Neo Discovery', 2001, 'PSA 9', 'Holo Rare', NOW(), NOW()),
('Metagross PSA 8', 140.00, 'Pokemon', 'Pokemon', 'Deoxys', 2005, 'PSA 8', 'Holo Rare', NOW(), NOW()),

-- Modern Pokemon
('Salamence GX PSA 10', 260.00, 'Pokemon', 'Pokemon', 'Celestial Storm', 2018, 'PSA 10', 'GX', NOW(), NOW()),
('Garchomp PSA 9', 180.00, 'Pokemon', 'Pokemon', 'Mysterious Treasures', 2007, 'PSA 9', 'Holo Rare', NOW(), NOW()),
('Lucario GX PSA 9', 220.00, 'Pokemon', 'Pokemon', 'Forbidden Light', 2018, 'PSA 9', 'GX', NOW(), NOW()),
('Gengar PSA 8', 150.00, 'Pokemon', 'Pokemon', 'Fossil', 1999, 'PSA 8', 'Holo Rare', NOW(), NOW()),
('Alakazam PSA 9', 190.00, 'Pokemon', 'Pokemon', 'Base Set', 1999, 'PSA 9', 'Holo Rare', NOW(), NOW());
